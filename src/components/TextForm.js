    ...
    return (
        <>
            <div className="container" style={{ color: props.mode === 'dark' ? 'white' : '#042743' }}>
                ...
                <button disabled={text.length === 0} className="btn btn-primary mx-1 my-1" onClick={clearscreen}>Clear</button>
            ...
            <div className="container my-3" style={{ color: props.mode === 'dark' ? 'white' : '#042743' }}>
                ...
                <p>{text.split(/\s+/).filter((func) => { return func.length !== 0 }).length} words & {text.length} characters</p>
                <p>{0.008 * text.split(" ").filter((func) => { return func.length !== 0 }).length} Minutes reading time</p>
                <h2>preview</h2>
